module Slideable
  ...
  HORIZONTAL_AND_VERTICAL_DIRS = [
    # :dx and :dy will be replaced with specific numbers
    [:dx, :dy], # left
    [:dx, :dy], # right
    [:dx, :dy], # up (vertical)
    [:dx, :dy]  # down (vertical)
  ...
  def move_dirs
    ...
    raise NotImplementedError # will raise an error if '#move_dirs' not implemented in the sub class. We include the error to remind us that we can't use the module without defining the method in the sub-class.
  end
